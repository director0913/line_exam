					...
					<form action="index.php?exam-master-questions-addquestion" method="post" class="form-horizontal">
						...
						<div class="form-group">
					  		...
					  		<div class="col-sm-9 form-inline">
						  		<select class="combox form-control" target="isectionselect" refUrl="?exam-master-questions-ajax-getsectionsbysubjectid&subjectid={value}" name="typesid">
					        		<option value="0">选择科目</option>
							  		{x2;tree:$types,subject,sid}
							  		<option value="{x2;v:subject['id']}">{x2;v:subject['title']}</option>
							  		{x2;endtree}
						  		</select>
							</div>
							<div class="form-group">

...
<!--     <?php $qid = 0;
 ...
 $qid++; ?>
     <tr data-row-id="5b778cf936098f6ee332d910">
      ...
      <td class="text-left" style="width:8%;"><?php echo $this->tpl_var['questypes'][$question['questiontype']]['questype']; ?></td>
      <td class="text-left" style="width:10%;">试题分类</td>
      <td class="text-left" style=""><?php echo $this->G->make('strings')->subString(strip_tags(html_entity_decode($question['question'])),135); ?></td>
      <td class="text-left" style="width:8%;"><?php if($question['questionlevel']==2){ ?>中<?php } elseif($question['questionlevel']==3){ ?>难<?php } elseif($question['questionlevel']==1){ ?>易<?php } ?></td>
